    ...
    <div class="middle">
        <div class="con">
            <div class="pic">
                 ...
                 <img src="<c:url value = '/template/web/asset/img/ball2.png' />" alt="">
            </div>
            <h1> SÂN BÓNG ĐÁ </h1>
            <ul>
            ...
            <button > <a href="<c:url value = '/chi-tiet-san-bong-da' />"> ĐẶT NGAY </a></button>
        </div>
        <div class="con">
            <div class="pic">
                 <!-- <img src="/img/caulong.png" alt=""> -->
                 <img src="<c:url value = '/template/web/asset/img/caulong.png' />" alt="">
            </div>
            <h1> SÂN CẦU LÔNG </h1>
            <ul>
            ...
            <button > <a href="<c:url value = '/chi-tiet-san-cau-long' />"> ĐẶT NGAY </a></button>
        </div>
        <div class="con">
            <div class="pic">
                 <!-- <img src="/img/tenis.png" alt=""> -->
                 <img src="<c:url value = '/template/web/asset/img/tenis.png' />" alt="">
            </div>
            <h1> SÂN TENNIS </h1>
            <ul>
            ...
            <button > <a href="<c:url value = '/chi-tiet-san-tennis' />"> ĐẶT NGAY </a></button>
        </div>
    </div>
